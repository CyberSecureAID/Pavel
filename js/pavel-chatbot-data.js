...
window.PV_CHATBOT_DATA = {
  ...
  ──────────────────────────────────────────── */
  welcome: [
    'Bienvenido. Mi nombre es Leo, soy el asistente virtual de esta empresa de ingenieria y tecnologia en la construccion. Estoy aqui para resolver sus consultas sobre nuestros servicios, proyectos y capacidades tecnicas.\n\n¿En que puedo ayudarle?',
    'Hola. Soy Leo, el asistente virtual de nuestra firma de ingenieria. Puede preguntarme sobre servicios, cobertura, tecnologia constructiva, certificaciones o cualquier aspecto relacionado con nuestros proyectos.',
    'Bienvenido. Me llamo Leo y estoy aqui para orientarle sobre nuestros servicios de ingenieria estructural, gestion de proyectos y tecnologia BIM.\n\nHagame su consulta con confianza.',
    'Hola. Soy Leo, asistente virtual de esta firma especializada en ingenieria y construccion. Si tiene preguntas sobre nuestros servicios, experiencia o como podemos ayudarle en su proyecto, estoy aqui para orientarle.'
  ],
