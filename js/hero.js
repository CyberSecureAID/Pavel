...
(function () {
  ...
  function onScroll() {
    ...
    if (header && serviciosSec) {
      ...
      if (headerForceHidden) header.classList.remove('header--peek');
    }
  ...
  /* ================================================
     HEADER OCULTO — peek sutil al acercar el cursor,
     reveal completo al hacer clic en esa franja.
  ================================================ */
  if (header) {
    window.addEventListener('mousemove', (e) => {
      if (!headerForceHidden) return;
      header.classList.toggle('header--peek', e.clientY <= 12);
    }, { passive: true });
