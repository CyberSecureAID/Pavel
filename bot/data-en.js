  ...
  kb: [
    ...
    /* ── General services ── */
    {
      ...
      answer: [
        ...
        'We are a firm based in Toronto, Canada, specializing in architecture, engineering, shop drawings, and permit services. We work on both residential and commercial projects, guaranteeing quality and on-time delivery.\n\nWould you like more details about any of our service areas?',
    ...
    /* ── Geographic coverage ── */
    {
      keys: [
        ...
        'canada', 'ontario', 'toronto', 'east york'
      ],
      answer: [
        'Our main office is located in **East York, Ontario, Canada**, at **29 Lankin Blvd, Toronto, ON M4J 4W7**. We primarily serve projects in the province of Ontario and across Canada, although we can also evaluate international projects under specific conditions.\n\nIf your project is in another region, contact us and we will study the feasibility.',
        'We operate from Toronto, Canada, with coverage across the Canadian territory. We have experience in commercial and residential projects in the Ontario region, and we are open to collaborating in other provinces upon agreement.\n\nDo you have a project in a specific location you would like to ask us about?',
        'We are strategically located in East York, near downtown Toronto. We serve clients throughout the metropolitan area and the rest of Ontario.\n\nFor projects outside Ontario, we can manage local teams or remote advisory depending on the scope.'
      ]
    },
    ...
    /* ── Projects / portfolio ── */
    {
      ...
      answer: [
        'We have a diverse portfolio including residential projects (single-family and multi-family) and commercial projects (offices, retail, mixed-use). We have completed architectural designs, structural calculations, shop drawings, and permit management in the Toronto area.\n\nVisit the **Projects** section of this page to see representative cases. If you need specific references, contact us and we will share examples similar to your project.',
