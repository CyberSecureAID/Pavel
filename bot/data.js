...
window.PV_CHATBOT_DATA = {
  ...
  kb: [
    ...
    /* ── Servicios generales ── */
    {
      ...
      answer: [
        ...
        'Somos una firma con sede en Toronto, Canadá, especializada en servicios de arquitectura, ingeniería, planos de taller y gestión de permisos. Trabajamos tanto en proyectos residenciales como comerciales, garantizando calidad y cumplimiento de plazos.\n\n¿Le gustaría conocer más detalles sobre alguna de nuestras áreas de servicio?',
    ...
    /* ── Cobertura geográfica ── */
    {
      keys: [
        ...
        'canadá', 'canada', 'ontario', 'toronto', 'east york'
      ],
      answer: [
        'Nuestra sede principal está en **East York, Ontario, Canadá**, en la dirección **29 Lankin Blvd, Toronto, ON M4J 4W7**. Atendemos principalmente proyectos en la provincia de Ontario y en todo Canadá, aunque también podemos evaluar proyectos internacionales bajo condiciones específicas.\n\nSi su proyecto está en otra región, contáctenos y estudiaremos la viabilidad.',
        'Operamos desde Toronto, Canadá, con cobertura en todo el territorio canadiense. Tenemos experiencia en proyectos comerciales y residenciales en la región de Ontario, y estamos abiertos a colaborar en otras provincias previo acuerdo.\n\n¿Tiene un proyecto en una ubicación específica sobre la que quiera consultarnos?',
        'Estamos ubicados estratégicamente en East York, cerca del centro de Toronto. Atendemos clientes en toda el área metropolitana y en el resto de Ontario.\n\nPara proyectos fuera de Ontario, podemos gestionar equipos locales o asesoría remota según el alcance.'
      ]
    },
    ...
    /* ── Proyectos / portafolio / ejemplos ── */
    {
      ...
      answer: [
        'Contamos con un portafolio diverso que incluye proyectos residenciales (viviendas unifamiliares y multifamiliares) y comerciales (oficinas, locales, edificios mixtos). Hemos realizado diseños arquitectónicos, cálculos estructurales, shop drawings y gestiones de permisos en la región de Toronto.\n\nPuede visitar la sección **Proyectos** de esta página para ver casos representativos. Si necesita referencias específicas, contáctenos y le compartiremos ejemplos similares a su proyecto.',
  ...
  contact: {
    ...
    email: 'info@jpocontracting.com'   /* Puedes cambiarlo por el correo real que uses */
  }
